		...
		<section className="header" id="header">
			<div className="header__hero">
				<div class="text__filled">
					<motion.h1 initial={{ x: -1800 }} animate={{ x: 0, transition: { duration: 0.8, delay: 2 } }} style={{ x: right }} className="title">
						Backend Developer
					</motion.h1>
				</div>
				...
				<div class="text__filled to-left">
					<motion.h1 initial={{ x: 1800 }} animate={{ x: 0, transition: { duration: 0.8, delay: 2 } }} style={{ x: left }} className="title">
						software engineer
					</motion.h1>
				</div>
