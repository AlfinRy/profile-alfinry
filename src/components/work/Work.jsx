			...
			<div className="work__container">
				<div className="work__menu">
					<div className="work__item">
						<img className="work__image" src={olshop} alt="outfit online shop" />
						<div className="work__button">
							{/* <a target="_blank" rel="noreferrer noopener" href="https://ruurmerch.000webhostapp.com/"> */}
					...
					<div className="work__text">
						...
						<div className="work__subtitle">
							<span className="title__link">Linktree</span>
							<p>Web</p>
						</div>
					</div>
				</div>
